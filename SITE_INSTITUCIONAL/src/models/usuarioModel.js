...
function cadastrarGerente(fkNRGerente, nomeGerente, cpfGerente, emailGerente, senhaGerente, fkLinha) {
    ...
    var instrucaoSql = `
        ...
        VALUES ('${fkNRGerente}', '${nomeGerente}', '${cpfGerente}', '${emailGerente}', '${senhaGerente}', '1', '2', '${fkLinha}');
    `;
