...
function cadastrarGerente(fkNRGerente, nomeGerente, cpfGerente, emailGerente, senhaGerente, representanteGerente) {
    ...
    //  e na ordem de inserção dos dados.
    var instrucaoSql = `
        INSERT INTO usuario (fkNR, nome, cpf, email, senha, cargo, status, fkResponsavel) VALUES ('${fkNRGerente}', '${nomeGerente}', '${cpfGerente}', '${emailGerente}', '${senhaGerente}', 'gerente', 'ativo', '${representanteGerente}');
    `;
    console.log("Executando a instrução SQL: \n" + instrucaoSql);
    return database.executar(instrucaoSql);
}
...
function cadastrarSuporte(fkNRSuporte, nomeTecnico, cpfTecnico, emailTecnico, senhaTecnico, representanteTecnico) {
    ...
    //  e na ordem de inserção dos dados.
    var instrucaoSql = `
        INSERT INTO usuario (fkNR, nome, cpf, email, senha, cargo, status, fkResponsavel) VALUES ('${fkNRSuporte}', '${nomeTecnico}', '${cpfTecnico}', '${emailTecnico}', '${senhaTecnico}', 'gerente', 'ativo', '${representanteTecnico}');
    `;
    console.log("Executando a instrução SQL: \n" + instrucaoSql);
    return database.executar(instrucaoSql);
}
